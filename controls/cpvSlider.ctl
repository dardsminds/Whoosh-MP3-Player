        ...
        Select Case m_Orientation
            ...
            Case 0 '# Horizontal
                    If Slider.Height < iRailPicture.Height Then
                       Size iRailPicture.Width * 15, iRailPicture.Height * 15
                    Else
...
Private Sub Refresh()
    ...
    If m_RailStyle = 99 Then
        ...
        Select Case m_Orientation
            ...
            Case 0 '# Horizontal
                    PaintPicture iRailPicture, 0, (ScaleHeight - iRailPicture.Height) * 0.5
                 
            Case 1 '# Vertical
                    PaintPicture iRailPicture, (ScaleWidth - iRailPicture.Width) * 0.5, 0
...
Attribute value.VB_UserMemId = 0
    ...
    Public Property Let value(ByVal New_Value As Long)
        ...
        If New_Value < m_Min Then m_Min = New_Value
        If New_Value > m_Max Then m_Max = New_Value
        m_Value = New_Value
